...
import 'package:farm_scheduling/core/helper/extensions/color_converter_extension.dart';
import 'package:farm_scheduling/core/mediators/bloc_hub/hub.dart';
import 'package:bloc/bloc.dart';
import 'package:equatable/equatable.dart';
import 'package:farm_scheduling/core/localization/app_lang.dart';
...
import 'package:farm_scheduling/core/mediators/communication_types/bool_type.dart';
...
extension AppBlocMappers on AppBloc {
  ...
  void _onLaunchApp(LaunchAppEvent event, Emitter<AppState> emit) async {
   ...
   await Future.delayed(const Duration(seconds: 3));
    ...
    appStatus: appStatus,
    //  appStatus: isFirstTime ? null : appStatus,
